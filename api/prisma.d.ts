...
******************************************************************************************/
/**
 * Этот автосгенерированный prisma orm файл 
 * поставляется разработчиком бекенда
 * он меняется каждый раз, когда произошли
 * изменения в структуре данных на бекенде
 **/
 ...
 export namespace Prisma {
   ...
   */
   ...
   export type EnumRolesWithAggregatesFilter = {
      ...
      *
      **/
     min?: NestedEnumRolesFilter;
     _max?: NestedEnumRolesFilter;
     /**
      * @deprecated since 2.23 because Aggregation keywords got unified to use underscore as prefix to prevent field clashes.
      *
      **/
     max?: NestedEnumRolesFilter;
   };
